$.ajax({
    url : 'https://api.unsplash.com/photos/random?collections=2097379&fit=clip&w=1920&h=1080&client_id=yourunsplashAPIkeygoeshere',
    type : 'GET',
    dataType : 'json',
   ...
   $('.photog-credit').html('Photog // <a href="' + photogurl + '?utm_source=yourappnamegoeshere&utm_medium=referral&utm_campaign=api-credit" target="_blank">' + photog + '</a>');
}
